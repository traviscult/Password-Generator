// Assignment Code
var characterAmountRange = document.getElementById('characterRange')
var characterAmountNumber = document.getElementById('characterNumber')
...
form.addEventListener('submit', e => {
  ...
  securepassword.innerText = password
})
